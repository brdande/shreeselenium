...
public class DynamicXPathExample {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * slect.selectByVisibleText("Baby"); List <WebElement>l = slect.getOptions();
		 * int size = l.size(); for(int i =0; i<size ; i++){ String options =
		 * l.get(i).getText(); System.out.println(options); }
		 */
		 Thread.sleep(3000);
